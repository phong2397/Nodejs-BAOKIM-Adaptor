...
var baokim = {
  registerVirtualAccount: async (requestInfo) => {
    let requestBody = {
  ...
  updateVirtualAccount: async (requestInfo) => {
    let requestBody = {
      RequestId: requestInfo.requestId,
      RequestTime: requestInfo.requestTime,
      PartnerCode: PARTNERCODE,
  ...
  retriveVirtualAccount: async (requestInfo) => {
    let requestBody = {
      RequestId: requestInfo.requestId,
      RequestTime: requestInfo.requestTime,
      PartnerCode: PARTNERCODE,
  ...
  // getCollectionAtPoint: async (requestInfo) => {
  //   let requestBody = {
  //     RequestId: requestInfo.requestId,
  //     RequestTime: requestInfo.requestTime,
  //     PartnerCode: PARTNERCODE,
  //     AccNo: requestInfo.accountNo,
  //     Signature: util.createRSASignature(
  //       `${requestInfo.requestId}|${requestInfo.requestTime}|${PARTNERCODE}|${requestInfo.accountNo}`,
  //       privateKey
  //     ),
  //   };
  //   let sign = util.createRSASignature(JSON.stringify(requestBody), privateKey);
